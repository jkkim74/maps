...
## 8/28 상한가 당일매매 V1 — ✅ 구현 커밋·푸시, 🟡 오버나이트 위험 통제는 설계까지
...
> ⚠️ **`main.py`·`scheduler.py` 어디에도 배선하지 않았다.** 모드 기본값은 `recommend_only`
> 이고 현재 상태로는 **실행되지 않는다.** 운영 영향 0 — 운영 HEAD `5abe150`, alembic `0028`.
